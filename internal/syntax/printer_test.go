...
func TestFormatStyle(t *testing.T) {
	tests := []struct {
		...
		{"control statements",
			"function f():void{ if(a){x=1;}elsif(b){x=2;}else{x=3;} while(i<10){i+=1;} loop(){break;} for(i,0,10){continue;} }\n",
			"function f():void\n{\n\tif (a) {\n\t\tx = 1;\n\t} elsif (b) {\n\t\tx = 2;\n\t} else {\n\t\tx = 3;\n\t}\n\twhile (i < 10) {\n\t\ti += 1;\n\t}\n\tloop() {\n\t\tbreak;\n\t}\n\tfor (i, 0, 10) {\n\t\tcontinue;\n\t}\n}\n"},
		{"if without block",
		...
		{"fc 2 true / false / null / *void",
			...
			"#fc 2\nvar p:*void;\nfunction f():bool\n{\n\tp = null;\n\tif (p == null) {\n\t\treturn true;\n\t}\n\treturn false;\n}\n"},
		{"v1 keeps true / null as identifiers", "var true:int = null;\n", "var true:int = null;\n"},
